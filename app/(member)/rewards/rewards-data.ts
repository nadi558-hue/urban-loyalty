...
const DEMO_REWARDS: Reward[] = [
  { id: 'demo-1', name: 'הקפצה בראש רשימת המתנה', description: 'קפיצה לראש רשימת ההמתנה בשיעור מלא', cost: 30, icon: 'waitlist', minTier: 'silver' },
  { id: 'demo-2', name: 'שריון מוקדם · שבוע מראש', description: 'פתיחת מערכת השעות שבוע לפני כולם', cost: 50, icon: 'early', minTier: 'silver' },
  { id: 'demo-3', name: '5% הנחה · חידוש מנוי או כרטיסייה', description: '5% הנחה על החידוש הבא (מנוי פעיל 3+ חודשים)', cost: 60, icon: 'discount', minTier: 'silver' },
  { id: 'demo-4', name: '10% הנחה · חידוש מנוי או כרטיסייה', description: '10% הנחה על החידוש הבא (מנוי פעיל 3+ חודשים)', cost: 260, icon: 'discount', minTier: 'gold' },
  { id: 'demo-5', name: 'שריון VIP · שבועיים מראש', description: 'פתיחת מערכת השעות שבועיים לפני כולם', cost: 200, icon: 'early', minTier: 'gold' },
  { id: 'demo-6', name: 'שיעור בודד מעבר למכסה', description: 'שיעור נוסף מעבר למכסת המנוי החודשי', cost: 160, icon: 'single_class', minTier: 'silver' },
]
